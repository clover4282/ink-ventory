class SubscriptionsController < ApplicationController
  ...
  def create
    ...
    group.subscriptions.find_or_create_by!(listing: listing, variant_external_id: params[:variant_external_id].to_s)
  ...
  def update
    ...
    @subscription.update!(
      variant_external_id: params.dig(:subscription, :variant_external_id).to_s,
